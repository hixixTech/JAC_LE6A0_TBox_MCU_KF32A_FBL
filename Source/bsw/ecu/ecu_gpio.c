...
/*48*/	{GPIO_I2C0_SDA_MCU	, GPIOC_SFR,	GPIO_Pin_Num_1	, GPIO_MODE_RMP	, GPIO_HIGH_SPEED, GPIO_POD_PP, TRUE,  		FALSE,	GPIO_RMP_AF8_I2C2,		LOW},	\
/*49*/	{GPIO_I2C0_SCL_MCU	, GPIOC_SFR,	GPIO_Pin_Num_2	, GPIO_MODE_RMP	, GPIO_HIGH_SPEED, GPIO_POD_PP, TRUE,  		FALSE,	GPIO_RMP_AF8_I2C2,		LOW},	\
...
/*54*/	{GPIO_RTC			, GPIOC_SFR,	GPIO_Pin_Num_9	, GPIO_MODE_OUT	, GPIO_HIGH_SPEED, GPIO_POD_PP, FALSE,  	FALSE,	GPIO_RMP_AF0_SYSTEM,	LOW},	\
