...
typedef enum 
{
    ...
    SPP_USER_DCPD_MSG_TO_MCU_CTR_VEH_RES_ACK_EVT,                   /*!< __Description:__ 切电响应消息ACK \n
                                                                       ...
                                                                       __ResponseData:__  \n
                                                               */ 
    SPP_USER_DCPD_MSG_TO_MCU_DRV_ANALY_ACK,                     /*!< __Description:__ 重卡驾驶行为上报消息ACK \n
                                                                       __Sender:__ Mpu_BigData \n
                                                                       __Receiver:__  Mcu_ICT\n
                                                                       __RequestData:__ 参考  \n
                                                                       __ResponseData:__  \n
                                                               */
...
typedef enum 
{
    ...
    SPP_USER_DCPD_MSG_TO_MPU_CTR_VEH_REQ_ACK_EVT,              /*!< __Description:__ 切电请求消息ACK \n
                                                                       ...
                                                                       __ResponseData:__  \n
                                                               */ 
    SPP_USER_DCPD_MSG_TO_MPU_RESET_TBOX_ACK_EVT, /* MCU reset ack */

    SPP_USER_DCPD_MSG_TO_MPU_DRV_ANALY_DATA_EVT,              /*!< __Description:__ 重卡驾驶行为数据上报事件 \n
                                                                       __Sender:__ Mcu_ICT \n
                                                                       __Receiver:__ Mpu_BigData \n
                                                                       __RequestData:__  DcpdPackageToMpuDrvAnalyData_t \n
                                                                       __ResponseData:__  \n
                                                               */
...
typedef enum
{
    ...
    VEH_REPORT_TYPE_FAILURE_CLASSIFICATION,
...
{  
 UINT16 u16Spd;         /*!< 车速  */
 UINT16 u16EngSpd;      /*!< 发动机转速   */
 UINT8 u8pedalPos;      /*!< 油门踏板开度   */
}DrvAnalyData_t;//重卡驾驶行为分析数据

typedef struct
{
    DcpdPackageHeader_t tHeader;    /*!< Dcpd Package Header*/   
 UINT16 u16InsFuelCons;         /*!< 瞬时油耗  */
 UINT8 u8AvgFuelCons;        /*!< 平均油耗   */
 UINT16 u16ResFuel;          /*!< 剩余燃油   */  
 UINT32 u32TotalMileage;    /*!< 总里程   */
 UINT8 u8WaterTemperature;   /*!< 水温   */
 UINT16 u16EnduraMileage;    /*!< 续航里程   */
 UINT8 u8EngState;  /*!< 发动机状态   */
 UINT8 u8VehState;      /*!< BIT0 刹车踏板状态
                              BIT1 离合踏板状态
                              BIT2 驾驶员安全带状态
                              BIT3 空档滑行状态
                              BIT4 发动机缸内制动状态
                              BIT5-7 预留   */
	UINT8 u8GearSta; /*!< 档位   */
    DrvAnalyData_t tDrvData[5];
}DcpdPackageToMpuDrvAnalyData_t;//MCU2MPU驾驶行为分析上报结构体
